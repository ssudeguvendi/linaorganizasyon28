(() => {
  ...
  function apply(lang){
    ...
    const fs=document.querySelectorAll('.feature-card'); if(fs[0]){set('.feature-card:nth-child(1) h3',t.f1);set('.feature-card:nth-child(1) p',t.f1t)} if(fs[1]){set('.feature-card:nth-child(2) h3',t.f2);set('.feature-card:nth-child(2) p',t.f2t)} if(fs[2]){set('.feature-card:nth-child(3) h3',t.f3);set('.feature-card:nth-child(3) p',t.f3t)}
